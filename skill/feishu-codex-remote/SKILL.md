...
- Reply directly for simple results. Use the bundled private Feishu publisher for long or structured results, then send a concise group summary and link. If publication or privacy hardening fails, send complete ordered message chunks.
