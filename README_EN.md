...
Want to use Codex remotely from your phone, or tired of waiting to reconnect whenever you switch back to the ChatGPT app? This Skill provides a simple path: send tasks to Codex on your computer and receive results through Feishu, view and download generated files on your phone, without exposing the project on your computer to the public internet or running a separate management dashboard.
...
- View and download files generated by Codex on your computer from your phone: images appear directly in chat, and explicitly delivered PDFs and Excel workbooks arrive as attachments; short results are sent directly, while long tutorials or complex layouts use private Feishu documents;
...
You can use Feishu on an iPhone, an Android phone, or a Huawei phone running HarmonyOS, without installing the ChatGPT app. Your phone only needs working access to Feishu; your computer must be connected to Feishu through this Skill, with Codex running and working network access.
...
### How can I view and download files generated by Codex on my computer from my phone?

Ask Codex to send the generated files to Feishu. Images appear directly in the group, and explicitly delivered PDFs and Excel workbooks arrive as attachments you can view or download on your phone, without returning to your computer to upload them yourself. Simple replies are sent directly in the group, while long or structurally complex content uses private Feishu documents. Image or attachment delivery failures are reported explicitly.
